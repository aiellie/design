 ...
 * aiellie theme tokens — the single source of truth for design tokens.
 * Imported by styles/globals.css, so :root carries the theme by default.
 * The .theme-aiellie class scopes the same tokens to a subtree.
 */
