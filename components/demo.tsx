          ...
          <Card className="w-full">
            <CardContent className="flex flex-col gap-6">
              ...
              <div className="flex items-center gap-4">
                <AlertDialog>
                  <AlertDialogTrigger render={<Button variant="outline"><span className="hidden md:block">Alert Dialog</span><span className="block md:hidden">Dialog</span></Button>} />
                ...
                <ButtonGroup>
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger render={<Button variant="outline" size="icon"><HugeiconsIcon icon={ArrowUp01Icon} strokeWidth={2} /></Button>} />
                    <DropdownMenuContent
                      align="end"
                      side="top"
                      className="w-fit"
