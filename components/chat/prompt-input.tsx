...
export const PromptInputActionAddAttachments = ({
  ...
  return (
    <DropdownMenuItem {...props} onSelect={handleSelect}>
      <HugeiconsIcon icon={Image01Icon} strokeWidth={2} className="mr-2 size-4" />
      {label}
    </DropdownMenuItem>
  );
};
...
export const PromptInputActionMenuTrigger = ({
  ...
  <DropdownMenuTrigger render={<PromptInputButton className={className} {...props} />}>{children ?? <HugeiconsIcon icon={PlusSignIcon} strokeWidth={2} className="size-4" />}</DropdownMenuTrigger>
);
